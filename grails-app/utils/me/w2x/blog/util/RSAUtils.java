...
public abstract class RSAUtils
{
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        byte[] bytes = encrypt(pub, plainText.getBytes(Constant.DEFAULT_ENCODING));

        byte[] _plainTextBytes = decrypt(pri, bytes);
        System.out.println(new String(_plainTextBytes, Constant.DEFAULT_ENCODING));
